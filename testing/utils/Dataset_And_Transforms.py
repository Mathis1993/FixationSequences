...
class SequenceModeling(object):
    ...
    - pad fixations with zeros to length of 15 (max length in training data is 12), to be able to use batch sizes bigger than one. The padded batch will be fed to the rnn using "pack_padded_sequence"
    """
