...
from utils.Train_Model_DEEPGAZE_BASED_overfit_train import train_model
...
#nur noch einen fc-layer für x,y-Koordinaten, einen für state
#Nur noch eine Loss-Functions
#Ziel: Overfit auf Trainingsdaten
...
#Start Training
model, train_loss, valid_loss = train_model(baseline_model, rnn_model, training_id, patience, n_epochs, gpu, plotter_train, plotter_eval, train_loader, val_loader, optimizer, criterion_fixations, lr)
